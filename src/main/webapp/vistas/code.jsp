        ...
        <div class="col">
            <form th:action="@{/code}" method="post" role="form">
                ...
                <fieldset>
                    ...
                    <h2 class="text-center">C�digo de verificaci�n</h2>
                    ...
                    <div class="form-group">
                        <input type="text" id="code" name="code" class="form-control input-lg" placeholder="C�digo de verificaci�n" required="true"/>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col">
