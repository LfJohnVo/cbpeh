...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
	...
	<li class="nav-item active justify-content-center"><a class="nav-link" href="#"> <i
            class="fas fa-fw fa-search"></i> <span>Accion de Busqueda</span></a>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a id="mColaboracion" class="collapse-item" href="#">Colaboraci�n</a>
                <a id="mAccionBusqueda" class="collapse-item" href="#">Acci�n de b�squeda</a>
