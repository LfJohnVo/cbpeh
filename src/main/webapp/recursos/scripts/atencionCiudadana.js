...
function guardarDesaparecidos(event) {
	...
	if (operaciones === null || operaciones === "") {
		formData.set("descripcionOperaciones", operaciones);
	}
	if (discapacidad === null || discapacidad === "") {
		formData.set("descripcionDiscapacidad", discapacidad);
	}
	if (fracturas === null || fracturas === "") {
		formData.set("descripcionFracturas", fracturas);
	}
	if (faltas === null || faltas === "") {
		formData.set("descripcionFaltas", faltas);
	}
	if (violencia === null || violencia === "") {
		formData.set("descripcionViolencia", violencia);
	}
	if (documento === null || documento === "") {
		formData.set("descripcionDocumentacion", documento);
	}
	if (documentos === null || documentos === "") {
		formData.set("descripcionDocumento", documentos);
	}
	if (llamadas === null || llamadas === "") {
		formData.set("descripcionLlamadas", llamadas);
	}
	if (transporte === null || transporte === "") {
		formData.set("descripcionTransporte", transporte);
	}
	if (hijos === null || hijos === "") {
		formData.set("descripcionHijos", hijos);
	}
